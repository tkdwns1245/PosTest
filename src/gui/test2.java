...
public class test2 extends MyFrameTemplate{
	...
	JPanel goodsNameP = new JPanel();
	JPanel priceP = new JPanel();
	JPanel numOfGoodsP = new JPanel();
	JPanel amountsP = new JPanel();
	
	JLabel goodsNameL = new JLabel("물품명");
	JLabel priceL = new JLabel("가격");
	JLabel numOfGoodsL = new JLabel("개수");
	JLabel amountsL = new JLabel("금액");
